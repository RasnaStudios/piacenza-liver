...
export class LiverModel {
  ...
  createLiver() {
    ...
    // Enhanced liver material for dramatic lighting
    const material = new THREE.MeshPhongMaterial({ 
      color: 0x8b6541, // Bronze base color
      shininess: 60, // More reflective for dramatic highlights
      specular: 0xd4af37, // Golden specular highlights
      transparent: false,
      opacity: 1.0
    })
