    ...
    <Box p="md">
      <Stack gap="md">
        ...
        <Stack gap="lg" style={{ textAlign: 'center' }}>
          ...
          <Box style={{ display: 'flex', justifyContent: 'space-around', gap: '32px' }}>
            <Box style={{ textAlign: 'center' }}>
              <Text size="xl" className="text-secondary" style={{ fontFamily: 'var(--font-primary)', marginBottom: '8px', fontWeight: 600 }}>
                Lorenzo Andraghetti
              </Text>
              <Text size="lg" className="text-tertiary" style={{ fontStyle: 'italic', marginBottom: '12px' }}>
                Developer
              </Text>
            ...
            <Box style={{ textAlign: 'center' }}>
              ...
              <Text size="lg" className="text-tertiary" mb="12px" style={{ fontStyle: 'italic' }}>
                3D Artist
              </Text>
              <Box style={{ display: 'flex', justifyContent: 'center', gap: '12px' }}>
                <Anchor 
          ...
          {/* Studio Links */}
          <Box mt="16px" display="flex" style={{ justifyContent: 'center', alignItems: 'center', gap: '24px' }}>
            <Anchor 
              href="https://github.com/rasnastudios/piacenza-liver" 
              target="_blank" 
              rel="noopener noreferrer"
              style={{ color: 'var(--bronze-text)', fontSize: '20px', fontWeight: 500, display: 'flex', alignItems: 'center', gap: '8px' }}
            >
