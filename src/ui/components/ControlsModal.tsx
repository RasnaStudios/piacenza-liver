...
export function ControlsModal({ opened, onClose, platform }: ControlsModalProps) {
    ...
    <Modal
      ...
      title={
        <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Title order={3} className="text-bronze" style={{ fontFamily: 'var(--font-display)', fontWeight: 600 }}>
            🎮 Controls
          </Title>
          <Button
            variant="subtle"
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = 'var(--bg-overlay-secondary)'
            }}
            onMouseLeave={(e) => {
